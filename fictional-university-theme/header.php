...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <script type="text/text/javascript" src="/js/scripts.js"></script>
      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          ...
          <nav class="main-navigation">
            <ul>
              <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 35) echo 'class="current-menu-item"'?>><a href="<?php echo site_url('/about-us') ?>">About Us</a></li>
